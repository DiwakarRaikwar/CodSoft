...
public class Main {
    public static void main(String[] args) {
        ...
        String []words = in.split("\\W+");//this function is inbuilt java function with the help of it we can divide it in groups of words        // counting  the input text into words and count frequencies
        ...
        System.out.print(" The numbers of total words in input string is "+ words.length);
    }
